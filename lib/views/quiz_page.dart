...
class _QuizPageState extends State<QuizPage> {
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          image: AssetImage("assets/hans${_currentIndex+1}.png"),
                          )
                       ),
                      ...
                      child: RaisedButton(
                        ...
                        child: Text( _currentIndex == (widget.questions.length - 1) ? "Concluir" : "Próximo"),
  ...
  Future<bool> _onWillPop() async {
    return showDialog<bool>(
      ...
      builder: (_) {
        return AlertDialog(
          content: Text("Tem certeza que quer sair? Seu progresso será perdido!"),
          title: Text("Atenção!"),
          actions: <Widget>[
            FlatButton(
              child: Text("Sim"),
